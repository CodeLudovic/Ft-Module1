...
LinkedList.prototype.mapHouses = function (word) {
	if (this.head == null && !word) {
		console.log("No encontramos cambios posibles");
	}
	let current = this.head;
...
let myHouses = new LinkedList();
myHouses.add("Casa Moderna");
myHouses.add("Casa Nueva");
myHouses.add("Casa Antigua");
myHouses.mapHouses("Casa Moderna");
